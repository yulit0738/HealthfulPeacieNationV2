var gcObject = {
  options: (options = {
    ...
    events: [{ date: new Date(), eventName: null, className: null, onclick: function (ev, data) {}, dateColor: "#38385c" }],
    ...
    calendarData.forEach(function (e) {
      ...
      e.forEach(function (e) {
        ...
        btnCell.click(function (ev) {
		  gcObject.options.onclickDate(ev, {
		    year: e.datejs.getFullYear(),
		    month: e.datejs.getMonth() + 1, // JavaScript의 월은 0부터 시작하므로 1을 더해줍니다.
		    date: e.date,
		  });
		});
